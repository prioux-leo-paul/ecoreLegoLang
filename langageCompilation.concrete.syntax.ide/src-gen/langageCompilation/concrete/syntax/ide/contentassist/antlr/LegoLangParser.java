...
public class LegoLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, LegoLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTheDoubleAccess().getGroup_2(), "rule__TheDouble__Group_2__0");
			...
			builder.put(grammarAccess.getTheDoubleAccess().getValue2Assignment_2_1(), "rule__TheDouble__Value2Assignment_2_1");
