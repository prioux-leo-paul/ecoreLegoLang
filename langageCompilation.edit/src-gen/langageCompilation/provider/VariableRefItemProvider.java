...
/**
 * This is the item provider adapter for a {@link langageCompilation.VariableRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableRefItemProvider extends ExpressionItemProvider {
	...
	protected void addVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						LangageCompilationPackage.Literals.VARIABLE_REF__VARIABLE, true, false, true, null, null,
						null));
	}
	...
	public String getText(Object object) {
		String label = ((VariableRef) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VariableRef_type")
				: getString("_UI_VariableRef_type") + " " + label;
	}
