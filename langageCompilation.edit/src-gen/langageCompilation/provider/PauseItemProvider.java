...
/**
 * This is the item provider adapter for a {@link langageCompilation.Pause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PauseItemProvider extends StatementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PauseItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LangageCompilationPackage.Literals.PAUSE__EXPRESSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Pause"));
	}
	...
	public String getText(Object object) {
		String label = ((Pause) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Pause_type")
				: getString("_UI_Pause_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pause.class)) {
		case LangageCompilationPackage.PAUSE__EXPRESSION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(LangageCompilationPackage.Literals.PAUSE__EXPRESSION,
