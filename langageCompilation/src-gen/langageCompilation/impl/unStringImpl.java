...
public class UnStringImpl extends VariableImpl implements UnString {
	...
	protected EClass eStaticClass() {
		return LangageCompilationPackage.Literals.UN_STRING;
	}
	...
	public void setInitialeValue(String newInitialeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LangageCompilationPackage.UN_STRING__INITIALE_VALUE,
