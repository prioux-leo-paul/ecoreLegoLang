...
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program {
	...
	protected EClass eStaticClass() {
		return LangageCompilationPackage.Literals.PROGRAM;
	}
	...
	public EList<Statement> getStatement() {
		if (statement == null) {
			statement = new EObjectContainmentEList<Statement>(Statement.class, this,
					LangageCompilationPackage.PROGRAM__STATEMENT);
		}
		return statement;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LangageCompilationPackage.PROGRAM__NAME, oldName,
					name));
	}
